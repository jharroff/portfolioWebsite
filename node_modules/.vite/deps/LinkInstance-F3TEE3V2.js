...
var LinkInstance = class {
  ...
  #getCachedStyle(rgb) {
    ...
    if (!style) {
      style = getStyleFromRgb(rgb, this.#container.hdr, void 0, this.#container.peakNits, this.#container.hdrMode);
...
//# sourceMappingURL=LinkInstance-F3TEE3V2.js.map
