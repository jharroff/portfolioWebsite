import {
  ...
  mouseLeaveEvent,
  mouseMoveEvent
} from "./chunk-UQCAJ6TQ.js";
import {
  DestroyType,
  RotateDirection
} from "./chunk-AAQKWPF7.js";
import {
  AnimatableColor,
  AnimationMode,
  AnimationStatus,
...
var BlendPlugin = class {
  ...
  async getPlugin(container) {
    const { BlendPluginInstance } = await import("./BlendPluginInstance-QPWL4JDW.js");
...
var MovePlugin = class {
  ...
  async getPlugin(container) {
    const { MovePluginInstance } = await import("./MovePluginInstance-5V2QUBPY.js");
...
var InteractivityPlugin = class {
  ...
  async getPlugin(container) {
    const { InteractivityPluginInstance } = await import("./InteractivityPluginInstance-HRXEQKXP.js");
...
function replaceImageColor(image, imageData, color, particle, hdr = false, peakNits, mode) {
  const svgColoredData = replaceColorSvg(image, color, particle.opacity?.value ?? defaultOpacity3, hdr, peakNits, mode), imageRes = {
    color,
    data: {
      ...image,
...
var ImagePreloaderPlugin = class {
  ...
  async getPlugin(container) {
    const { ImagePreloaderInstance } = await import("./ImagePreloaderInstance-3GFQR3SQ.js");
...
var OverlapPlugin = class {
  id = "overlap";
  async getPlugin(container) {
    const { OverlapPluginInstance } = await import("./OverlapPluginInstance-VZ7HSSPQ.js");
...
var LinksPlugin = class {
  ...
  async getPlugin(container) {
    const { LinkInstance } = await import("./LinkInstance-F3TEE3V2.js");
